...
在复旦大学 MagicLab、丁文超老师指导下持续参与科研，目前开展具身智能中的世界模型方向研究。
...
\cvsection{科研经历}
\begin{cventry}{具身智能中的世界模型研究}{当前研究}{复旦大学 MagicLab \textbar{} 指导老师：丁文超}
\begin{cvitems}
\item 研究如何利用真实执行反馈，帮助具身世界动作模型发现预测与执行之间的偏差，并修正后续动作。
\end{cvitems}
\end{cventry}
