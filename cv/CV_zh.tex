...
复旦大学计算机科学与技术本科生，平均成绩 \textbf{90/100}。在 MagicLab、丁文超老师指导下，以世界动作模型为主要实验平台，研究长时序机器人操作中的执行反馈、策略适应与失败恢复。

\cvsection{教育经历}
\begin{cventry}{复旦大学}{2023.09 - 至今}{计算机科学与技术 本科在读 \textbar{} 上海}
\begin{cvitems}
\item 本科期间入选计算机科学与技术拔尖人才试验班。
\item 平均成绩：\textbf{90/100}。
\end{cvitems}
\end{cventry}

\begin{cventry}{得克萨斯大学奥斯汀分校}{2025.08 - 2025.12}{计算机科学 本科交换 \textbar{} 美国奥斯汀}
\begin{cvitems}
\item GPA：\textbf{4.0/4.0}，共 13 学分；机器学习、计算机视觉、操作系统、概率与随机过程四门课程均为 A。
\end{cvitems}
\end{cventry}

\cvsection{科研经历}
\begin{cventry}{面向机器人操作的执行反馈与恢复研究}{进行中}{复旦大学 MagicLab \textbar{} 指导老师：丁文超}
\begin{cvitems}
\item 基于 LingBot-VA 与 LIBERO-Long 搭建执行反馈实验，通过状态重放与受控干预，区分模型输出变化、可行恢复动作与闭环任务完成。
\item 研究任务状态反馈与恢复数据适配如何帮助同一策略在子任务交接时修订动作，并保持任务所需的已有进展。
\item 探索反馈相对普通恢复训练的作用，以及预测未来的额外价值；初步成功限于特定状态与阶段，泛化能力仍在研究中。
\end{cvitems}
\end{cventry}
