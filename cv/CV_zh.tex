...
在复旦大学 MagicLab、丁文超老师指导下持续参与科研，以世界动作模型为主要实验平台，研究长时序机器人操作中的执行反馈、策略适应与失败恢复。

\cvsection{教育经历}
\begin{cventry}{复旦大学}{2023.09 - 至今}{计算机科学与技术 本科在读 \textbar{} 上海}
\begin{cvitems}
\item 本科期间入选计算机科学与技术拔尖人才试验班。
\item 平均成绩：\textbf{90/100}（复旦大学官方换算，证明日期：2026 年 9 月 17 日）。
\end{cvitems}
\end{cventry}

\begin{cventry}{得克萨斯大学奥斯汀分校}{2025.08 - 2025.12}{计算机科学 本科交换 \textbar{} 美国奥斯汀}
\begin{cvitems}
\item 共 13 学分；机器学习、计算机视觉、操作系统、概率与随机过程四门课程均为 A。
\end{cvitems}
\end{cventry}
