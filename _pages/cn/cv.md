...
======
* **多任务机器人信息采集中的主动感知**
  * *研究助理 (导师: Junhong Xu)*，美国奥斯汀，2025.09 - 2025.12
  * 在部分可观测条件下构建多任务仿真基准，覆盖未知物体属性与未知空间位置两类核心设定
  * 实现并对比 IL、RL、IL 预训练 + RL 微调三类训练范式
...
* **部分可观测环境下的自动驾驶风险地图学习**
  ...
  * 研究成果已被 IEEE Robotics and Automation Letters (RA-L) 接收
...
* **字节跳动（抖音研发）测试开发实习生**
  * 中国上海，2026.01 - 至今
  * 重构并扩展内部检查与测试用例，准确率由 89% 提升至 100%
  * 覆盖率由 95% 提升至 98%
  * 正在开发基于大模型的 QA 流程效率工具
